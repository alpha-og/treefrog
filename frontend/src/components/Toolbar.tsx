...
import { Zap, Sun, Moon, Home, FileText, Eye, Sidebar as SidebarIcon } from "lucide-react";
  ...
  return (
    <>
      ...
      <header className="bg-base-100 border-b border-base-content/10 px-6 py-3 flex items-center justify-between gap-6 h-16">
        ...
        {/* Center: Primary Build Action - Fixed width */}
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <div className="relative">
            ...
            >
              <Zap size={16} className="text-base-content/60" />
            </button>
