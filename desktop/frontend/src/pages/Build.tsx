...
const mockBuild: BuildDetail = {
  ...
  duration: 180,
  logs: `This is pdfTeX, Version 3.14159265-2.6-1.40.21 (TeX Live 2020/Debian)
[... compilation logs ...]
Output written on output.pdf (42 pages, 2345678 bytes).
Transcript written on transcript.log.`,
  artifacts: [
    { type: "pdf", size: 2345678, url: "/artifacts/output.pdf" },
    { type: "log", size: 45678 },
    { type: "aux", size: 123456 },
  ],
};
